  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        ...
        >
          <ShieldCheck className="w-4 h-4" /> Build Customer Trust
        </span>
        ...
        >
          SOC 2 Compliance <br className="hidden md:block" />
        ...
        >
          Cyethack Solutions guides you through the entire SOC 2 journey, from
          gap analysis to audit readiness, helping you demonstrate your commitment to security.
        </p>
  ...
  const challenges = [
    {
      ...
      description:
        "Navigating the Trust Services Criteria (Security, Availability, Confidentiality, etc.) can be overwhelming without expert guidance.",
      icon: <FileText className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Vendor Demands",
      description:
        "Enterprise customers increasingly require SOC 2 Type II reports before signing contracts, stalling sales cycles.",
      icon: <Users className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Resource Drain",
      description:
        "Preparing for an audit internally distracts your engineering and product teams from their core responsibilities.",
  ...
  const soc2Services = [
    {
      ...
      description:
        "We evaluate your current controls against SOC 2 criteria to identify deficiencies and create a roadmap for compliance.",
      icon: <Search className="w-6 h-6 text-blue-600" />,
      image: "/services/soc2_gap.png",
    },
    {
      title: "Policy & Procedure Development",
      description:
        "We help you draft and implement the necessary information security policies and procedures tailored to your organization.",
      icon: <FileText className="w-6 h-6 text-blue-600" />,
      image: "/services/soc2_policy.png",
    },
    {
      title: "Control Implementation Support",
      description:
        "Guidance on implementing technical and administrative controls to meet Trust Services Criteria requirements.",
      icon: <Settings className="w-6 h-6 text-blue-600" />,
      image: "/services/soc2_controls.png",
    },
    {
      title: "Audit Preparation & Liaison",
      description:
        "We act as your advocate during the audit process, helping you gather evidence and answer auditor inquiries.",
      icon: <Users className="w-6 h-6 text-blue-600" />,
      image: "/services/soc2_audit.png",
    },
    {
      title: "Continuous Compliance Monitoring",
      description:
        "Ongoing monitoring to ensure your controls remain effective over time, simplifying future audits (Type II).",
      icon: <Repeat2 className="w-6 h-6 text-blue-600" />,
      image: "/services/soc2_monitor.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = soc2Services[activeService];

  return (
    <section id="soc2-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
          ...
          >
            We provide end-to-end support to help you achieve and maintain SOC 2
            compliance efficiently, minimizing disruption to your business.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:w-1/2 w-full space-y-4">
            {soc2Services.map((service, index) => (
              <div
                key={index}
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`SOC 2 Service: ${currentService.title}`}
