  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        {/* Animated Tag */}
        <span
          className={`inline-flex items-center gap-2 mb-4 px-4 py-1 text-sm font-medium rounded-full bg-purple-700/30 text-purple-400 border border-purple-500/50 ${isVisible ? "animate-fade-in-down" : "opacity-0"
            }`}
        >
          <ShieldCheck className="w-4 h-4" /> Data Privacy First
        </span>
        ...
        >
          GDPR Compliance <br className="hidden md:block" />
        ...
        >
          Navigate the complexities of data protection regulations with confidence.
          Cyethack Solutions helps you safeguard personal data and avoid hefty fines.
        </p>
  ...
  const challenges = [
    {
      title: "Data Mapping",
      description:
        "Understanding exactly what personal data you hold, where it resides, and how it flows is the biggest hurdle for most organizations.",
      icon: <Search className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Consent Management",
      description:
        "Collecting and managing valid user consent in a compliant manner across all digital touchpoints is technically complex.",
      icon: <Users className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Breach Notification",
      description:
        "The 72-hour mandatory breach notification window leaves no room for error or delay when an incident occurs.",
  ...
  const gdprServices = [
    {
      ...
      description:
        "Systematic process to identify and minimize the data protection risks of a project, required for high-risk processing activities.",
      icon: <FileText className="w-6 h-6 text-purple-600" />,
      image: "/services/gdpr_dpia.png",
    },
    {
      title: "Data Mapping & Inventory",
      description:
        "Create a comprehensive Record of Processing Activities (RoPA) to visualize data flows and ensure accountability.",
      icon: <Search className="w-6 h-6 text-purple-600" />,
      image: "/services/gdpr_mapping.png",
    },
    {
      title: "Privacy Policy Review",
      description:
        "Draft and review privacy notices to ensure they are transparent, concise, and compliant with Article 13/14 requirements.",
      icon: <BookOpen className="w-6 h-6 text-purple-600" />,
      image: "/services/gdpr_policy.png",
    },
    {
      title: "DPO as a Service",
      description:
        "Outsource the Data Protection Officer role to our experts, ensuring you have the required independence and expertise without the headcount.",
      icon: <Users className="w-6 h-6 text-purple-600" />,
      image: "/services/gdpr_dpo.png",
    },
    {
      title: "GDPR Training & Awareness",
      description:
        "Educate your employees on data privacy principles and their role in maintaining compliance to build a privacy-first culture.",
      icon: <MonitorCheck className="w-6 h-6 text-purple-600" />,
      image: "/services/gdpr_training.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = gdprServices[activeService];

  return (
    <section id="gdpr-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
            className={`text-sm font-bold text-purple-600 uppercase tracking-wider mb-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"
              }`}
          >
            Our Approach
          </p>
          ...
          <div
            className={`h-1 w-16 bg-purple-500 rounded-full mb-8 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"
              }`}
          />
          <p
          ...
          >
            We provide practical solutions to help you meet GDPR requirements,
            protecting your customers' privacy and your organization's reputation.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`GDPR Service: ${currentService.title}`}
