  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        ...
        >
          <ShieldCheck className="w-4 h-4" /> Secure Connected Devices
        </span>
        ...
        >
          IoT Security <br className="hidden md:block" />
        ...
        >
          From smart home devices to industrial sensors, we secure the Internet of Things.
          Identify vulnerabilities in hardware, firmware, and communication protocols.
        </p>
  ...
  const challenges = [
    {
      ...
      description:
        "Shadow IoT devices often connect to the network without authorization, creating unmanaged entry points for attackers.",
      icon: <Eye className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Weak Authentication",
      description:
        "Many IoT devices ship with default credentials or weak authentication mechanisms that are easily exploited.",
      icon: <Lock className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Firmware Vulnerabilities",
      description:
        "Outdated or insecure firmware can harbor critical vulnerabilities that are difficult to patch remotely.",
  ...
  const iotServices = [
    {
      ...
      description:
        "Comprehensive testing of the entire IoT ecosystem, including the device, mobile app, cloud backend, and communication protocols.",
      icon: <Target className="w-6 h-6 text-cyan-600" />,
      image: "/services/iot_pentest.png",
    },
    {
      title: "Firmware Security Analysis",
      description:
        "Reverse engineering and binary analysis of device firmware to identify hardcoded credentials, encryption keys, and vulnerabilities.",
      icon: <Cpu className="w-6 h-6 text-cyan-600" />,
      image: "/services/iot_firmware.png",
    },
    {
      title: "IoT Architecture Review",
      description:
        "Assess the security design of your IoT solution, focusing on secure boot, data encryption, and device identity management.",
      icon: <Network className="w-6 h-6 text-cyan-600" />,
      image: "/services/iot_arch.png",
    },
    {
      title: "Protocol Fuzzing",
      description:
        "Test the robustness of communication protocols (MQTT, CoAP, Zigbee, BLE) against malformed inputs and denial-of-service attacks.",
      icon: <Wifi className="w-6 h-6 text-cyan-600" />,
      image: "/services/iot_fuzzing.png",
    },
    {
      title: "Compliance Testing",
      description:
        "Verify compliance with IoT security standards such as ETSI EN 303 645, NIST IR 8259, and IOXT Alliance requirements.",
      icon: <Award className="w-6 h-6 text-cyan-600" />,
      image: "/services/iot_compliance.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = iotServices[activeService];

  return (
    <section id="iot-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
          ...
          >
            Secure your connected world. We provide end-to-end security testing
            and advisory services for consumer, commercial, and industrial IoT devices.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`IoT Service: ${currentService.title}`}
