  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        {/* Animated Tag */}
        <span
          className={`inline-flex items-center gap-2 mb-4 px-4 py-1 text-sm font-medium rounded-full bg-teal-700/30 text-teal-400 border border-teal-500/50 ${isVisible ? "animate-fade-in-down" : "opacity-0"
            }`}
        >
          <ShieldCheck className="w-4 h-4" /> Protect Patient Data
        </span>
        ...
        >
          HIPAA Compliance <br className="hidden md:block" />
        ...
        >
          Safeguard Protected Health Information (PHI) and ensure regulatory compliance.
          Cyethack Solutions provides comprehensive HIPAA security services for healthcare organizations.
        </p>
  ...
  const challenges = [
    {
      title: "PHI Security",
      description:
        "Ensuring the confidentiality, integrity, and availability of electronic Protected Health Information (ePHI) against evolving cyber threats.",
      icon: <Lock className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Vendor Management",
      description:
        "Ensuring that all Business Associates and third-party vendors are also compliant with HIPAA regulations to prevent downstream breaches.",
      icon: <Users className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Audit Readiness",
      description:
        "Being prepared for an OCR audit requires meticulous documentation of policies, risk assessments, and training records.",
  ...
  const hipaaServices = [
    {
      ...
      description:
        "Conduct a thorough assessment of potential risks and vulnerabilities to the confidentiality, integrity, and availability of ePHI.",
      icon: <Search className="w-6 h-6 text-teal-600" />,
      image: "/services/hipaa_risk.png",
    },
    {
      title: "Policy & Procedure Development",
      description:
        "Create and implement comprehensive security policies and procedures tailored to your organization's specific needs and HIPAA requirements.",
      icon: <FileText className="w-6 h-6 text-teal-600" />,
      image: "/services/hipaa_policy.png",
    },
    {
      title: "Technical Safeguards Assessment",
      description:
        "Evaluate your technical controls, including access control, audit controls, integrity, and transmission security, to ensure they meet HIPAA standards.",
      icon: <MonitorCheck className="w-6 h-6 text-teal-600" />,
      image: "/services/hipaa_tech.png",
    },
    {
      title: "Breach Response Planning",
      description:
        "Develop and test a robust incident response plan to ensure timely and effective action in the event of a data breach.",
      icon: <AlertTriangle className="w-6 h-6 text-teal-600" />,
      image: "/services/hipaa_breach.png",
    },
    {
      title: "Employee Training",
      description:
        "Provide mandatory security awareness training to all workforce members to ensure they understand their roles and responsibilities in protecting PHI.",
      icon: <Users className="w-6 h-6 text-teal-600" />,
      image: "/services/hipaa_training.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = hipaaServices[activeService];

  return (
    <section id="hipaa-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
            className={`text-sm font-bold text-teal-600 uppercase tracking-wider mb-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"
              }`}
          >
            Our Approach
          </p>
          ...
          <div
            className={`h-1 w-16 bg-teal-500 rounded-full mb-8 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"
              }`}
          />
          <p
          ...
          >
            We help healthcare providers, payers, and business associates navigate
            the complexities of HIPAA to protect patient data and avoid penalties.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:w-1/2 w-full space-y-4">
            {hipaaServices.map((service, index) => (
              <div
                key={index}
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`HIPAA Service: ${currentService.title}`}
