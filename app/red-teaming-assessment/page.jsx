  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        {/* Animated Tag */}
        <span
          className={`inline-flex items-center gap-2 mb-4 px-4 py-1 text-sm font-medium rounded-full bg-red-700/30 text-red-400 border border-red-500/50 ${isVisible ? "animate-fade-in-down" : "opacity-0"
            }`}
        >
          <ShieldCheck className="w-4 h-4" /> Simulate Real-World Attacks
        </span>
        ...
        >
          Test Your Defenses <br className="hidden md:block" />
        ...
        >
          Cyethack Solutions' Red Teaming services go beyond standard penetration testing
          to simulate a full-scale, multi-vector attack on your organization's people,
...
const TheChallengeSection = () => {
  ...
  const challenges = [
    {
      title: "Sophisticated Adversaries",
      description:
        "Real attackers don't follow a checklist. They use social engineering, physical breaches, and custom malware to bypass traditional defenses.",
      icon: <Target className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Detection Gaps",
      description:
        "Many organizations have security tools but fail to detect active intrusions until it's too late. Red Teaming tests your SOC's response capabilities.",
      icon: <Eye className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Human Vulnerability",
      description:
        "Employees are often the weakest link. Phishing and social engineering attacks can compromise even the most secure technical environments.",
  ...
  const redTeamServices = [
    {
      ...
      description:
        "A comprehensive, objective-based simulation where our experts attempt to breach your organization using any means necessary—digital, physical, and social.",
      icon: <Target className="w-6 h-6 text-red-600" />,
      image: "/services/redteam_full.png",
    },
    {
      title: "Social Engineering Assessments",
      description:
        "Test your employees' security awareness through targeted phishing, vishing (voice phishing), and smishing campaigns designed to harvest credentials or deliver payloads.",
      icon: <Mail className="w-6 h-6 text-red-600" />,
      image: "/services/redteam_social.png",
    },
    {
      title: "Physical Security Assessment",
      description:
        "Evaluate the physical security controls of your offices and data centers. We attempt to bypass locks, cameras, and guards to gain unauthorized access.",
      icon: <Lock className="w-6 h-6 text-red-600" />,
      image: "/services/redteam_physical.png",
    },
    {
      title: "Purple Teaming",
      description:
        "A collaborative exercise where our Red Team works alongside your Blue Team (defenders) to test and improve detection and response capabilities in real-time.",
      icon: <Users className="w-6 h-6 text-red-600" />,
      image: "/services/redteam_purple.png",
    },
    {
      title: "Ransomware Simulation",
      description:
        "Emulate the tactics, techniques, and procedures (TTPs) of modern ransomware groups to test your organization's resilience and recovery procedures.",
      icon: <AlertTriangle className="w-6 h-6 text-red-600" />,
      image: "/services/redteam_ransomware.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = redTeamServices[activeService];

  return (
    <section id="redteam-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
            className={`text-sm font-bold text-red-600 uppercase tracking-wider mb-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"
              }`}
          >
            Key Services
          </p>
          ...
          <div
            className={`h-1 w-16 bg-red-500 rounded-full mb-8 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"
              }`}
          />
          <p
          ...
          >
            Our Red Teaming services expose the vulnerabilities that automated scans miss,
            providing a realistic assessment of your organization's ability to withstand
            a targeted attack.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:w-1/2 w-full space-y-4">
            {redTeamServices.map((service, index) => (
              <div
                key={index}
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`Red Team Service: ${currentService.title}`}
