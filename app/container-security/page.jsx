  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        ...
        >
          <ShieldCheck className="w-4 h-4" /> Secure Your Modern Infrastructure
        </span>
        ...
        >
          Container & K8s <br className="hidden md:block" />
        ...
        >
          Cyethack Solutions secures your containerized applications and orchestration
          platforms (Kubernetes, OpenShift) from build to runtime, ensuring agility
...
const TheChallengeSection = () => {
  ...
  const challenges = [
    ...
    {
      title: "Orchestration Misconfigurations",
      description:
  ...
  const containerServices = [
    {
      ...
      image: "/services/container_k8s.png",
    },
    {
      title: "Container Image Scanning",
      description:
        "Automated and manual analysis of your container images to identify OS vulnerabilities, malware, and exposed secrets before they reach the registry.",
      icon: <Box className="w-6 h-6 text-indigo-600" />,
      image: "/services/container_scanning.png",
    },
    {
      title: "Runtime Security Monitoring",
      description:
        "Implement tools and strategies to detect anomalous behavior in running containers, such as unexpected shell execution or network connections.",
      icon: <Eye className="w-6 h-6 text-indigo-600" />,
      image: "/services/container_runtime.png",
    },
    {
      title: "Infrastructure as Code (IaC) Security",
      description:
        "Scan your Terraform, Helm charts, and Dockerfiles for security misconfigurations early in the development lifecycle.",
      icon: <Code className="w-6 h-6 text-indigo-600" />,
      image: "/services/container_iac.png",
    },
    {
      title: "Microservices Security Architecture",
      description:
        "Design secure communication patterns (Service Mesh, mTLS) and authentication mechanisms for your microservices architecture.",
      icon: <Network className="w-6 h-6 text-indigo-600" />,
      image: "/services/container_microservices.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = containerServices[activeService];

  return (
    <section id="container-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
          ...
          >
            Our Container Security services provide end-to-end protection for your
            cloud-native stack, ensuring that your move to microservices doesn't
            introduce new risks.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`Container Service: ${currentService.title}`}
