  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        {/* Animated Tag */}
        <span
          className={`inline-flex items-center gap-2 mb-4 px-4 py-1 text-sm font-medium rounded-full bg-indigo-700/30 text-indigo-400 border border-indigo-500/50 ${isVisible ? "animate-fade-in-down" : "opacity-0"
            }`}
        >
          <ShieldCheck className="w-4 h-4" /> Global Security Standard
        </span>
        ...
        >
          ISO 27001 <br className="hidden md:block" />
        ...
        >
          Establish a world-class Information Security Management System (ISMS)
          with Cyethack Solutions. We guide you from initial assessment to successful certification.
        </p>
  ...
  const challenges = [
    {
      ...
      description:
        "ISO 27001 requires extensive documentation of policies, procedures, and records, which can be a massive administrative burden.",
      icon: <FileText className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Risk Complexity",
      description:
        "Conducting a comprehensive risk assessment and treatment plan (ISO 27005) requires specialized knowledge and methodology.",
      icon: <AlertTriangle className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Audit Anxiety",
      description:
        "Facing external auditors without proper preparation can lead to non-conformities and certification failure.",
  ...
  const isoServices = [
    {
      ...
      description:
        "Design and build a robust Information Security Management System (ISMS) tailored to your business context and objectives.",
      icon: <Settings className="w-6 h-6 text-indigo-600" />,
      image: "/services/iso_isms.png",
    },
    {
      title: "Risk Assessment (ISO 27005)",
      description:
        "Identify, analyze, and evaluate information security risks. We help you define a risk treatment plan to mitigate identified threats.",
      icon: <AlertTriangle className="w-6 h-6 text-indigo-600" />,
      image: "/services/iso_risk.png",
    },
    {
      title: "Internal Audit",
      description:
        "Conduct independent internal audits to verify ISMS effectiveness and identify non-conformities before the external certification audit.",
      icon: <Search className="w-6 h-6 text-indigo-600" />,
      image: "/services/iso_audit.png",
    },
    {
      title: "Certification Support",
      description:
        "We stand by your side during Stage 1 and Stage 2 audits, helping you address auditor findings and achieve certification.",
      icon: <Award className="w-6 h-6 text-indigo-600" />,
      image: "/services/iso_cert.png",
    },
    {
      title: "Maintenance & Surveillance",
      description:
        "Ensure ongoing compliance and readiness for annual surveillance audits with our continuous improvement support.",
      icon: <Repeat2 className="w-6 h-6 text-indigo-600" />,
      image: "/services/iso_maintain.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = isoServices[activeService];

  return (
    <section id="iso-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
            className={`text-sm font-bold text-indigo-600 uppercase tracking-wider mb-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"
              }`}
          >
            Our Approach
          </p>
          ...
          <div
            className={`h-1 w-16 bg-indigo-500 rounded-full mb-8 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"
              }`}
          />
          <p
          ...
          >
            Achieve the gold standard in information security. We simplify the
            path to ISO 27001 certification with practical, business-aligned solutions.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`ISO Service: ${currentService.title}`}
