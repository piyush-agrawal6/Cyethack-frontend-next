  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        {/* Animated Tag */}
        <span
          className={`inline-flex items-center gap-2 mb-4 px-4 py-1 text-sm font-medium rounded-full bg-rose-700/30 text-rose-400 border border-rose-500/50 ${isVisible ? "animate-fade-in-down" : "opacity-0"
            }`}
        >
          <ShieldCheck className="w-4 h-4" /> 24/7 Threat Vigilance
        </span>
        ...
        >
          Proactive Threat <br className="hidden md:block" />
        ...
        >
          Cyethack Solutions provides continuous monitoring and rapid incident response
          to detect, contain, and neutralize threats before they impact your business.
        </p>
  ...
  const challenges = [
    {
      title: "Alert Fatigue",
      description:
        "Security teams are overwhelmed by thousands of alerts daily, leading to missed critical threats and delayed response times.",
      icon: <AlertTriangle className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Stealthy Attacks",
      description:
        "Advanced Persistent Threats (APTs) use sophisticated techniques to evade traditional signature-based detection and remain hidden for months.",
      icon: <Eye className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Slow Response",
      description:
        "Without a defined incident response plan and dedicated team, containing a breach can take days or weeks, increasing the damage.",
...
const tdrServices = [
  {
    ...
    description:
      "24/7 monitoring of your endpoints, networks, and cloud environments. Our SOC team investigates alerts and takes action to stop threats.",
    icon: <ShieldCheck className="w-6 h-6 text-rose-600" />,
    image: "/services/tdr_mdr.png",
  },
  {
    title: "Threat Hunting",
    description:
      "Proactive search for hidden threats that have evaded automated detection. We use hypothesis-driven hunting to find indicators of compromise (IoCs).",
    icon: <Target className="w-6 h-6 text-rose-600" />,
    image: "/services/tdr_hunting.png",
  },
  {
    title: "Incident Response Retainer",
    description:
      "Guaranteed availability of our IR experts when you need them most. We handle containment, eradication, and recovery during a cyber crisis.",
    icon: <PhoneCall className="w-6 h-6 text-rose-600" />,
    image: "/services/tdr_ir.png",
  },
  {
    title: "SIEM Optimization",
    description:
      "Tune your SIEM to reduce noise and improve detection fidelity. We help you ingest the right logs and create custom correlation rules.",
    icon: <Settings className="w-6 h-6 text-rose-600" />,
    image: "/services/tdr_siem.png",
  },
];
...
const OTSecurityServicesSection = () => {
  ...
  const currentService = tdrServices[activeService];

  return (
    <section id="tdr-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
            className={`text-sm font-bold text-rose-600 uppercase tracking-wider mb-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"
              }`}
          >
            Key Services
          </p>
          ...
          <div
            className={`h-1 w-16 bg-rose-500 rounded-full mb-8 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"
              }`}
          />
          <p
          ...
          >
            Our TDR services combine advanced technology with human expertise to
            detect sophisticated attacks and respond with speed and precision.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`TDR Service: ${currentService.title}`}
...
// --- MAIN EXPORT ---
// --- MAIN EXPORT ---
export default function ThreatDetectionResponsePage() {
  return (
    <div className="min-h-screen bg-white">
      <HeroSection />
      <TheChallengeSection />
      <OurSolutionSection /> {/* New Methodology Section */}
      <OTSecurityServicesSection /> {/* Renamed/Reused for TDR Services */}
