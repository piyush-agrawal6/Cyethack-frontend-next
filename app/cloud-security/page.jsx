  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        {/* Animated Tag */}
        <span
          className={`inline-flex items-center gap-2 mb-4 px-4 py-1 text-sm font-medium rounded-full bg-sky-700/30 text-sky-400 border border-sky-500/50 ${isVisible ? "animate-fade-in-down" : "opacity-0"
            }`}
        >
          <ShieldCheck className="w-4 h-4" /> Secure Your Cloud
        </span>
        ...
        >
          Cloud Security <br className="hidden md:block" />
        ...
        >
          ...
          Identify misconfigurations and vulnerabilities in AWS, Azure, and GCP environments.
        </p>
  ...
  const cloudServices = [
    {
      ...
      image: "/services/cloud_pentest.png",
    },
    {
      title: "Cloud Security Posture Management (CSPM)",
      description:
        "Continuous monitoring and assessment of your cloud environments to detect and remediate misconfigurations and compliance violations.",
      icon: <MonitorCheck className="w-6 h-6 text-sky-600" />,
      image: "/services/cloud_cspm.png",
    },
    {
      title: "Container Security",
      description:
        "Secure your containerized applications (Docker, Kubernetes) throughout the entire lifecycle, from build to runtime.",
      icon: <Box className="w-6 h-6 text-sky-600" />,
      image: "/services/cloud_container.png",
    },
    {
      title: "Serverless Security",
      description:
        "Identify and mitigate security risks in serverless functions (Lambda, Azure Functions) and event-driven architectures.",
      icon: <Code className="w-6 h-6 text-sky-600" />,
      image: "/services/cloud_serverless.png",
    },
    {
      title: "Cloud Compliance",
      description:
        "Ensure your cloud environments meet industry standards and regulatory requirements such as SOC 2, ISO 27001, and HIPAA.",
      icon: <Award className="w-6 h-6 text-sky-600" />,
      image: "/services/cloud_compliance.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = cloudServices[activeService];

  return (
    <section id="cloud-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
            className={`text-sm font-bold text-sky-600 uppercase tracking-wider mb-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"
              }`}
          >
            Our Approach
          </p>
          ...
          <div
            className={`h-1 w-16 bg-sky-500 rounded-full mb-8 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"
              }`}
          />
          <p
          ...
          >
            We help you navigate the complexities of cloud security. Our services
            ensure your cloud journey is secure, compliant, and resilient.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`Cloud Service: ${currentService.title}`}
