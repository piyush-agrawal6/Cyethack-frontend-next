  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        ...
        >
          <ShieldCheck className="w-4 h-4" /> Fortify Your Perimeter
        </span>
        ...
        >
          Network Security <br className="hidden md:block" />
        ...
        >
          ...
          Identify vulnerabilities in your network architecture, devices, and configurations.
        </p>
  ...
  const challenges = [
    {
      ...
      description:
        "Proliferation of devices and remote work endpoints expands the attack surface, making it harder to enforce security policies.",
      icon: <MonitorCheck className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Insider Threats",
      description:
        "Malicious or negligent insiders can bypass perimeter defenses, requiring robust internal segmentation and monitoring.",
      icon: <Users className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Advanced Persistent Threats",
      description:
        "Sophisticated attackers can lurk undetected in your network for months, exfiltrating sensitive data and mapping your infrastructure.",
  ...
  const networkServices = [
    {
      ...
      description:
        "Simulate real-world attacks on your internal and external networks to identify exploitable vulnerabilities and validate existing controls.",
      icon: <Target className="w-6 h-6 text-indigo-600" />,
      image: "/services/network_pentest.png",
    },
    {
      title: "Vulnerability Assessment",
      description:
        "Automated and manual scanning of network assets to identify known vulnerabilities, misconfigurations, and missing patches.",
      icon: <Search className="w-6 h-6 text-indigo-600" />,
      image: "/services/network_va.png",
    },
    {
      title: "Firewall Configuration Review",
      description:
        "Analyze firewall rule sets to ensure they are optimized, secure, and compliant with industry best practices and organizational policies.",
      icon: <ShieldCheck className="w-6 h-6 text-indigo-600" />,
      image: "/services/network_firewall.png",
    },
    {
      title: "Wireless Security Assessment",
      description:
        "Evaluate the security of your Wi-Fi networks, identifying weak encryption, rogue access points, and potential for unauthorized access.",
      icon: <Wifi className="w-6 h-6 text-indigo-600" />,
      image: "/services/network_wifi.png",
    },
    {
      title: "Segmentation Testing",
      description:
        "Verify that your network segmentation controls effectively isolate critical assets and prevent lateral movement by attackers.",
      icon: <Layers className="w-6 h-6 text-indigo-600" />,
      image: "/services/network_segmentation.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = networkServices[activeService];

  return (
    <section id="network-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
          ...
          >
            We help you build a resilient network infrastructure that can withstand
            modern cyber threats. Our services cover every aspect of network security.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`Network Service: ${currentService.title}`}
