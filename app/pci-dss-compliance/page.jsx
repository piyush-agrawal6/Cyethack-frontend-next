  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1312px] mx-auto px-6 text-center">
        {/* Animated Tag */}
        <span
          className={`inline-flex items-center gap-2 mb-4 px-4 py-1 text-sm font-medium rounded-full bg-blue-700/30 text-blue-400 border border-blue-500/50 ${isVisible ? "animate-fade-in-down" : "opacity-0"
            }`}
        >
        ...
        >
          PCI DSS Compliance <br className="hidden md:block" />
        ...
        >
          Protect cardholder data and ensure seamless payment operations.
          Cyethack Solutions guides you through every step of the PCI DSS journey.
        </p>
  ...
  const challenges = [
    {
      title: "Scope Creep",
      description:
        "Failing to properly define and segment the Cardholder Data Environment (CDE) can drastically increase audit scope and costs.",
      icon: <Layers className="w-8 h-8 text-red-500" />,
    },
    {
      title: "Continuous Compliance",
      description:
        "PCI DSS is not a one-time check. Maintaining compliance requires continuous monitoring, logging, and vulnerability management.",
      icon: <Repeat2 className="w-8 h-8 text-orange-500" />,
    },
    {
      title: "Third-Party Risk",
      description:
        "Managing the security of third-party service providers who handle cardholder data is a critical and often overlooked requirement.",
  ...
  const pciServices = [
    {
      title: "Gap Analysis",
      description:
        "Assess your current security posture against PCI DSS requirements to identify deficiencies and create a remediation roadmap.",
      icon: <Search className="w-6 h-6 text-blue-600" />,
      image: "/services/pci_gap.png",
    },
    {
      title: "QSA Audit Support",
      description:
        "Prepare for your formal assessment with our expert guidance. We help you gather evidence, address findings, and liaise with the QSA.",
      icon: <Award className="w-6 h-6 text-blue-600" />,
      image: "/services/pci_audit.png",
    },
    {
      title: "ASV Scanning",
      description:
        "Perform required quarterly external vulnerability scans using an Approved Scanning Vendor (ASV) solution to identify and fix vulnerabilities.",
      icon: <MonitorCheck className="w-6 h-6 text-blue-600" />,
      image: "/services/pci_asv.png",
    },
    {
      title: "Penetration Testing (PCI)",
      description:
        "Conduct mandatory annual penetration testing (network and application) to verify the security of your Cardholder Data Environment.",
      icon: <Target className="w-6 h-6 text-blue-600" />,
      image: "/services/pci_pentest.png",
    },
    {
      title: "SAQ Assistance",
      description:
        "Guidance on selecting and completing the correct Self-Assessment Questionnaire (SAQ) for your specific merchant or service provider level.",
      icon: <FileText className="w-6 h-6 text-blue-600" />,
      image: "/services/pci_saq.png",
    },
  ];

  const [activeService, setActiveService] = useState(0);
  const currentService = pciServices[activeService];

  return (
    <section id="pci-services" className="py-32 bg-white" ref={ref}>
      <div className="max-w-[1312px] mx-auto px-6">
        <div className="mb-20">
          <p
            className={`text-sm font-bold text-blue-600 uppercase tracking-wider mb-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"
              }`}
          >
            Our Approach
          </p>
          ...
          <div
            className={`h-1 w-16 bg-blue-500 rounded-full mb-8 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"
              }`}
          />
          <p
          ...
          >
            Ensure the security of cardholder data and maintain customer trust.
            We provide end-to-end support for PCI DSS compliance.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 w-full sticky lg:top-28">
            ...
            >
              <img
                ...
                alt={`PCI Service: ${currentService.title}`}
